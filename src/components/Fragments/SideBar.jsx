    ...
    <aside className="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
      <div className="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
          ...
          <li className="relative px-6 py-3">
            <span
              className="absolute inset-y-0 left-0 w-1 bg-green-800 rounded-tr-lg rounded-br-lg"
              aria-hidden="true"
            ></span>
            <a
        ...
        <div className="px-6 my-6">
          <button className="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-800 border border-transparent rounded-lg active:bg-green-800 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
            Create account
